...
class MADDPG(Algorithm):
    ...
    def __init__(self,
        ...
        super().__init__(agent_init_params=agent_init_params, alg_types=alg_types, gamma=gamma, tau=tau, lr=lr,
                         ...
                         lambdac_1=lambdac_1, lambdac_2=lambdac_2, lambdac_3=lambdac_3, embed_proportion=embed_proportion)
    ...
    def update_agent(self, sample, agent_i):
        ...
        # Computes current state-action value  # TODO: support feature_extractor
        ...
        if self.use_discrete_action:
            ...
            curr_pol_out = curr_agent.policy(curr_agent.f_e(observations[agent_i]), return_embed_logits=False)
    ...
    def create_train_recorder(self):
        return TrainingRecorder(
            stuff_to_record=['total_reward', 'actor_loss', 'critic_loss', 'agent_colors', 'eval_episodes',
                             'eval_total_reward_explore', 'eval_total_reward_exploit', 'JE_loss', 'JPGE_loss'])
    ...
    def init_from_env(cls,
        ...
        for action_space, observation_space, alg_type in zip(env.action_space, env.observation_space, alg_types):
            ...
            if alg_type in ["MADDPG", 'CoachMADDPG']:  # TODO: support feature extractor
                num_in_critic = 0
