...
def check_training_args(config):
    ...
    if config.feature_extractor == "convNet":
        ...
        raise NotImplemented  # TODO: shared_football does not support convnet for now. Compare branches "shared-ba8db4b" and "plug_football_env-d7ff954" to figure out what to do
